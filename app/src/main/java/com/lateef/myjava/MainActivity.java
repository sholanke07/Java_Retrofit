...
public class MainActivity extends AppCompatActivity {
    ...
    //private final ArrayList<Post> nameList = new ArrayList<>();
     List<Post> nameList;
        ...
        call.enqueue(new Callback<List<Post>>() {
            ...
            public void onResponse(Call<List<Post>> call, Response<List<Post>> response) {
                ...
                for (Post post : posts){
                    ...
                    mRvNameList.setLayoutManager(new LinearLayoutManager(MainActivity.this));
                    PostAdapter postAdapter = new PostAdapter(MainActivity.this, nameList);
                    mRvNameList.setAdapter(postAdapter);
